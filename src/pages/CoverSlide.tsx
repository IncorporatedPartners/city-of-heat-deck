  ...
  return (
    <div className="h-full flex relative overflow-hidden">
      ...
      <div className="w-1/2 p-16 flex flex-col justify-center relative z-10">
        <div className="font-mono text-xs text-coh-orange tracking-widest mb-12 uppercase">SEASON ONE // FINISHING FUND</div>

        <div className="flex flex-col mb-12">
          <h1 className="font-bebas text-[11rem] leading-[0.8] text-white tracking-tighter">CITY</h1>
          <h1 className="font-bebas text-[11rem] leading-[0.8] text-outline-orange tracking-tighter">OF</h1>
          <h1 className="font-bebas text-[11rem] leading-[0.8] text-coh-orange tracking-tighter">HEAT</h1>
        </div>

        <div className="border-l-2 border-coh-orange pl-6 mb-10 max-w-md">
          <p className="text-coh-light text-base leading-relaxed">
        ...
        <div className="font-mono text-[9px] text-coh-gray tracking-wider mb-10 max-w-md uppercase space-y-1">
        ...
        <div className="flex gap-24 font-mono text-[10px] tracking-widest uppercase">
          <div>
      ...
      {/* Right — GIF progress indicators */}
      <div className="w-1/2 relative z-10 flex items-end justify-end p-12">
