  ...
  <div className="h-full flex flex-col relative overflow-hidden">
    ...
    <div className="flex-1 flex flex-col md:flex-row relative z-10 overflow-y-auto">
      ...
      <div className="w-full md:w-5/12 p-5 md:p-10 flex flex-col justify-center">
        <div className="font-mono text-[9px] md:text-[10px] text-coh-orange tracking-widest mb-3 md:mb-4 uppercase">
          FRANCHISE ARCHITECTURE // 5-SEASON ARC
        </div>

        <h2 className="font-bebas text-3xl md:text-5xl leading-[0.9] mb-4 md:mb-6 tracking-wide">
        ...
        {SEASONS.map((season, i) => (
          ...
          >
            ...
            <div className="flex-1 p-3 md:p-4 flex items-center gap-3 md:gap-6">
              ...
              <div className={`font-mono text-[7px] md:text-[8px] tracking-widest px-1.5 md:px-2 py-0.5 md:py-1 border shrink-0 ${
